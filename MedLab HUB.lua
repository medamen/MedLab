...
elseif game.PlaceId == 5865858426 then
    ...
    local ServerSection = Server:NewSection("Server")
        ...
        -- Rejoin Smallest Server V2
        ServerSection:NewButton("Rejoin Smallest Server V2", "Rejoin The Smallest Server", function()
        ...
        -- Server Hopper
        ServerSection:NewButton("Server Hopper", "Change to the Different Server", function()
